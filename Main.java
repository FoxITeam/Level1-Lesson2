...
public class Main {
    ...
    public static void lesson1() {
        ...
        // sout
        // ctrl + alt + l
        // TODO 1. Задать целочисленный массив, состоящий из элементов 0 и 1. Например: [ 1, 1, 0, 0, 1, 0, 1, 1, 0, 0 ]. С помощью цикла и условия заменить 0 на 1, 1 на 0;
        int[] foxs = new int[10];
        foxs[0] = 1;
        foxs[1] = 1;
        foxs[2] = 0;
    ...
    public static void lesson2() {
        ...
        // ctrl + alt + l
        // Стандарт решения
        // TODO 2. Задать пустой целочисленный массив размером 8. С помощью цикла заполнить его значениями 0 3 6 9 12 15 18 21;
        int[] foxs = new int[8];
//      foxs[0] = 0;
//      foxs[1] = 3;
//      foxs[2] = 6;
...
//      foxs[7] = 21;
    ...
    public static void lesson3() {
        ...
        // TODO 3. Задать массив [ 1, 5, 3, 2, 11, 4, 5, 2, 4, 8, 9, 1 ] пройти по нему циклом, и числа меньшие 6 умножить на 2;
        int[] foxs = new int[12];
        foxs[0] = 1;
        foxs[1] = 5;
        foxs[2] = 3;
